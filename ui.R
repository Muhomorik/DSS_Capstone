  ...
  tabPanel("Prediction",
           fluidPage(fluidRow(
             column(
               ...
               p("continue tying: ..are professor of the year. If you type less than 3 words
               ...
               fluidRow(
                 ...
                 column(
                   ...
                   p("Best match for current work in KEY1, next work in KEY2.")
                 ),
                 column(
                   width = 3,
                   h5("3-ngrams "),
                   p("Predicts next word based on previous 1 words."),
                   p("Best match for current work in KEY2, next work in KEY3.")
                 ),
                 column(
                   width = 4,
                   h5("4-ngrams "),
                   p("Predicts next word based on previous 2 words."),
                   p("Best match for current work in KEY3, next work in KEY4.")
                 )
               ),
