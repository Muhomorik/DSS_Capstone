...
db_name <- "DssSwiftKeyApp/grams_db1.sqlite"
```
...
![app_structure](DssSwiftKeyApp/myimg/App.png)
*App flow*
...
![weight_inversemax](DssSwiftKeyApp/myimg/weight_inversemax.png)
*inversemax formula*
...
![how_works_short](DssSwiftKeyApp/myimg/Prediction.png)
...
![app](DssSwiftKeyApp/myimg/Filter.png)
*Exploratory data analysis*

Script takes a small sample as Train set and a next sample, not included in Train 
as Test set. Sample is around 3Mb,

Same rules ar applied to both sets. Then both results are merged into the *data.table* 
...
![app](DssSwiftKeyApp/myimg/FillGramsDb.png)
...
![app](DssSwiftKeyApp/myimg/FillGrams_running.png)
...
![app](DssSwiftKeyApp/myimg/FillGrams_cmd.png)
*cmd file*
