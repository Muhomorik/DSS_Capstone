...
I am slightly disappointing by the JHU and SwiftKey for ignoring the project.

I think JHU should have provided a set with predicted values to train a model.
